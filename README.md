...
<p align="center">
  <img src="docs/assets/video-demo.svg" width="100%" alt="マイブリッジ《動く馬》を図形の軌跡で再構成したアニメーションSVG" />
</p>
<p align="center"><sub>
エドワード・マイブリッジ《動く馬》(1878年・パブリックドメイン)を動画パイプラインで再構成した実出力
(15フレーム・図形140個)。図形が明滅せず<b>軌跡として動く</b>のがフレーム独立処理との違い
</sub></p>
